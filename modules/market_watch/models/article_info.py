...
class ArticleInfo:
    def __init__(self, company, news_portal, title, date, link, brief, author=None):
        ...
        self._company = self.cleaner_(self._company)
        self._news_portal = self.cleaner_(self._news_portal)
        self._link = self.cleaner_(self._link)
        self._brief = self.cleaner_(self._brief)
        self._author = self.cleaner_(self._author)
